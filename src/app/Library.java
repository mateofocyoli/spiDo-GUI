...
public class Library {
    ...
    private static final String COM_FILE_NAME = "ambrogio.jpg";
    private static final Path SAVEFILES_DIR_PATH = Path.of(ASSETS_DIR_NAME, SAVEFILES_DIR_NAME);
    private static final Path ASSETS_DIR_PATH = Path.of(ASSETS_DIR_NAME);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            FileManager.assertFileExistency(ASSETS_DIR_PATH, new String[]{COM_FILE_NAME});
