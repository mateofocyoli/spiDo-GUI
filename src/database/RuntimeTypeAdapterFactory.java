 ...
 * is necessary when a
 * field's type is not the same type that GSON should create when deserializing
 * that field. For
 ...
 * field name to the
 * {@link #of} factory method. If you don't supply an explicit type field name,
 * {@code "type"} will
 * be used.
 *
 * <pre>{@code
 ...
 * registered. This protects
 * your application from injection attacks. If you don't supply an explicit type
 * label, the type's
